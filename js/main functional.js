...
------------------------------------------- */
    ...
    function reinitializeScripts() {
        // Reinitialize all necessary event listeners and dynamic elements
        $('.sb-faq li .sb-question').off('click').on('click', function() {
            $(this).find('.sb-plus-minus-toggle').toggleClass('sb-collapsed');
            $(this).parent().toggleClass('sb-active');
        });

        // Other reinitializations like Isotope, Fancybox, etc.
        // Ensure preloader is hidden after content replacement
        $(".sb-preloader").addClass('sb-hidden');
    }
    
    reinitializeScripts(); // Call initially to apply scripts on page load
